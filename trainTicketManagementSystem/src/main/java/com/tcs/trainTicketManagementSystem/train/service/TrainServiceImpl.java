...
public class TrainServiceImpl implements TrainService {
    ...
    public TrainResponse createTrain(TrainRequest request) {
        ...
        // Validate journey duration is positive
        if (!request.isValidJourneyDuration()) {
            throw new IllegalArgumentException("Journey duration must be positive and reasonable (minimum 1 minute, maximum 1 week)");
        }
        ...
        Train train = new Train(
                ...
                request.getJourneyHours(),
                request.getJourneyMinutes(),
                request.getStatus()
        );
    ...
    public TrainResponse updateTrain(Long trainId, TrainRequest request) {
        ...
        train.setJourneyHours(request.getJourneyHours());
        train.setJourneyMinutes(request.getJourneyMinutes());
