...
public class UserController {
  ...
  public ResponseEntity<UserResponse> registerUser(
    ...
    logger.info(
      "Received user registration request for username: {}",
      request.getUsername()
    );
  ...
  public ResponseEntity<LoginResponse> loginUser(
    ...
    logger.info(
      "Received login request for username/email: {}",
  ...
  @Operation(
    ...
    description = "Searches users by username pattern"
  )
  @ApiResponses(
    value = {
      @ApiResponse(
  ...
  public ResponseEntity<UserResponse> resetPassword(
    ...
    logger.info(
      "Password reset successfully for user with ID: {}",
      response.getUserId()
    );
    return ResponseEntity.ok(response);
  }
